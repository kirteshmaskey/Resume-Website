function dropDownMenu(){
    ...
    if(dm.className == "nav-list"){
        ...
        document.getElementById('About-me').style.paddingTop = "40%";
        document.getElementById('Resume').style.paddingTop = "40%";
        document.getElementById('Certificate').style.paddingTop = "32%";
        document.getElementById('Contact-me').style.paddingTop = "40%";
    }
}
